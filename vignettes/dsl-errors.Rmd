...
Invalid call to `group()` used on the right hand side.  This function takes no arguments.
...
Invalid assignment of `group()`.  If you use `group()` on the right hand side of an expression, then the left hand side must be a symbol.
