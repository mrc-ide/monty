...
template <>
constexpr
std::array<uint64_t, 2> jump_constants<xoroshiro128starstar>() {
...
template <>
constexpr
std::array<uint64_t, 2> jump_constants<xoroshiro128plusplus>() {
  return std::array<uint64_t, 2>{{
...
template <>
constexpr
std::array<uint64_t, 2> jump_constants<xoroshiro128plus>() {
  return jump_constants<xoroshiro128starstar>();
}
...
template <>
constexpr
std::array<uint64_t, 2> long_jump_constants<xoroshiro128starstar>() {
  return std::array<uint64_t, 2>{{
...
template <>
constexpr
std::array<uint64_t, 2> long_jump_constants<xoroshiro128plusplus>() {
  return std::array<uint64_t, 2>{{
...
template <>
constexpr
std::array<uint64_t, 2> long_jump_constants<xoroshiro128plus>() {
  return long_jump_constants<xoroshiro128starstar>();
}

template <>
inline __host__ __device__
uint64_t next(xoroshiro128starstar& state) {
...
template <>
inline __host__ __device__
uint64_t next(xoroshiro128plusplus& state) {
  const uint64_t s0 = state[0];
  uint64_t s1 = state[1];
...
template <>
inline __host__ __device__
uint64_t next(xoroshiro128plus& state) {
  const uint64_t s0 = state[0];
  uint64_t s1 = state[1];
