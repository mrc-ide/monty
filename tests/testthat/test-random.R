...
test_that("Can vary parameters across streams", {
  ...
  r <- matrix(monty_random_state(s), ncol = 3)
  cmp <- lapply(1:3, function(i) {
    monty_random_create(seed = r[, i], n_streams = 1)
  })
  rate <- c(0.1, 0.2, 0.3)
